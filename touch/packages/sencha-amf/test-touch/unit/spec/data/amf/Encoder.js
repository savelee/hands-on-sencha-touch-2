        ...
        describe("data types", function() {
            ...
            describe("string", function() {
                ...
                it("should encode Greek", function() {
                    var str = "Γαζέες καὶ μυρτιὲς δὲν θὰ βρῶ πιὰ στὸ χρυσαφὶ ξέφωτο";
                    encoder.writeObject(str);
                    expect(encoder.getBytes()).toEqual([
                ...
                it("should encode Icelandic", function() {
                    var str = "Kæmi ný öxi hér ykist þjófum nú bæði víl og ádrepa";
                    encoder.writeObject(str);
                    expect(encoder.getBytes()).toEqual([
                ...
                it("should encode Japanese (Hiragana)", function() {
                    var str = "いろはにほへとちりぬるをわかよたれそつねならむうゐのおくやまけふ" +
                            "こえてあさきゆめみしゑひもせす";
                    encoder.writeObject(str);
                    expect(encoder.getBytes()).toEqual([
                ...
                it("should encode Japanese (Katakana)", function() {
                    var str = "イロハニホヘト チリヌルヲ ワカヨタレソ ツネナラム ウヰノオクヤマ " +
